...
public class SchedulePresenter : Control
{
    ...
    {
        { TimeOnly.Parse("8:30"), 0},
        { TimeOnly.Parse("10:05"), 1},
        { TimeOnly.Parse("12:00"), 2},
        { TimeOnly.Parse("13:35"), 3},
        { TimeOnly.Parse("15:30"), 4},
        { TimeOnly.Parse("17:05"), 5},
        { TimeOnly.Parse("19:00"), 6},
        { TimeOnly.Parse("20:35"), 7}
    };
    ...
    private void GetWeeklyTimeRange()
    {
        ...
        IOrderedEnumerable<Lesson>? list = null;
        if (ShowAllLessons)
        {
            list = Lessons
